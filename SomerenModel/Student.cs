...
namespace SomerenModel
{
    public class Student
    {
        ...
        public Student(string firstName, string lastName, string phoneNumber, string @class, int vouchers, int roomId)
        {
            FirstName = firstName;
            LastName = lastName;
        ...
        public Student(int studentId, string firstName, string lastName, string phoneNumber, string @class, int vouchers, int roomId)
